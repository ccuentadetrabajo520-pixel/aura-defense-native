                                                                                                ...
                                                                                                val bgPaint = Paint().apply { color = Color.parseColor("#0D1117") }
                                                                                                        ...
                                                                                                        canvas.drawRect(0f, 0f, PAGE_WIDTH.toFloat(), PAGE_HEIGHT.toFloat(), bgPaint)
                                                                                                                ...
                                                                                                                canvas.drawText("AURA DEFENSE", MARGIN.toFloat(), y, titlePaint)
                                                                                                                        y += 20f
                                                                                                                                canvas.drawText("Informe de seguridad", MARGIN.toFloat(), y, mutedPaint)
                                                                                                                                        y += 10f
                                                                                                                                                canvas.drawText("Generado: ${SimpleDateFormat("yyyy-MM-dd HH:mm", Locale.getDefault()).format(Date())}", MARGIN.toFloat(), y, mutedPaint)
                                                                                                                                                        y += 35f

                                                                                                                                                                canvas.drawText("SCORE: $score/100  |  $status", MARGIN.toFloat(), y, headerPaint)
                                                                                                                                                                        y += 30f

                                                                                                                                                                                canvas.drawText("TELEMETRÍA", MARGIN.toFloat(), y, headerPaint)
                                                                                                                                                                                        y += 20f
                                                                                                                                                                                                canvas.drawText("Apps analizadas: $appCount  |  Apps con riesgo: $riskyAppCount", MARGIN.toFloat(), y, bodyPaint)
                                                                                                                                                                                                        y += 18f
                                                                                                                                                                                                                        canvas.drawText("VPN: ${if (vpnActive) "Activa" else "Inactiva"}  |  DNS: $dnsStatus", MARGIN.toFloat(), y, bodyPaint)
                                                                                                                                                                                                                        y += 30f

                                                                                                                                                                                                                                canvas.drawText("HALLAZGOS", MARGIN.toFloat(), y, headerPaint)
                                                                                                                                                                                                                                        y += 20f
                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                    y += 15f
                                                                                                                                                                                                                                                                                                canvas.drawText(item.evidence, (MARGIN + 10).toFloat(), y, mutedPaint)
                                                                                                                                                                                                                                                                                                            y += 20f
                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                            if (findings.isEmpty()) {
                                                                                                                                                                                                                                                                                                                                            canvas.drawText("No se detectaron señales de riesgo.", MARGIN.toFloat(), y, bodyPaint)
                                                                                                                                                                                                                                                                                                                            }

                                                                                                                                                                                                                                                                                                                                    y = (PAGE_HEIGHT - MARGIN).toFloat()
                                                                                                                                                                                                                                                                                                                                                    canvas.drawText("Aura Defense — Ciberdefensa móvil privada", MARGIN.toFloat(), y, mutedPaint)
