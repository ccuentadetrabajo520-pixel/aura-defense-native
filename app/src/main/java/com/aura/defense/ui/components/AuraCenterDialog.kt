...
fun AuraCenterDialog(
    ...
    val tools = listOf("Escáner de apps", "Analizador de enlaces", "QR Anti-Phishing", "Auditor de contraseñas", "Escáner de contenido compartido", "Protección de notificaciones", "Inteligencia de amenazas", "Guardián Aura", "Historial inteligente", "Analizador de archivos", "Reportes", "Bóveda cifrada", "Modo emergencia", "Comprobaciones programadas", "Tile de acceso rápido", "Auras LAN", "Integridad del dispositivo", "Auditoría de permisos", "Verificación HIBP", "Certificado de seguridad", "Funciones avanzadas", "Seguridad avanzada", "Herramientas avanzadas")
